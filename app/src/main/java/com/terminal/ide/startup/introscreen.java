        ...
        MainListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == position_run && id == id_run) {
                    ...
                    startActivityForResult(new Intent(introscreen.this, installer.class), install_activity_requestCode);
                } else if (position == position_keyboard && id == id_keyboard) {
                    InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                    imm.showInputMethodPicker();
                } else if (position == position_setting && id == id_setting) {
                    startActivity(new Intent(introscreen.this, TerminalIDEPrefs.class));
                } else if (position == position_help && id == id_help) {
                    startActivity(new Intent(introscreen.this, tutlist.class));
    ...
    class whAdapter extends ArrayAdapter<MainItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == position_run) {
                //判断是否安装gcc
                SharedPreferences check = PreferenceManager.getDefaultSharedPreferences(introscreen.this);
    ...
    public boolean onOptionsItemSelected(com.actionbarsherlock.view.MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.main_activity_action_about: {
                startActivity(new Intent(introscreen.this, aboutActivity.class));
                break;
            }

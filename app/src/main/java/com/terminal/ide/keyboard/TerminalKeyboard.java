...
import com.terminal.ide.EmulatorView;
...
//        builder.setIcon(R.drawable.ic_dialog_keyboard);
        builder.setNegativeButton(getString(R.string.cmd_keyboard_options_cancel), null);
        CharSequence itemSettings = getString(R.string.cmd_keyboard_options_keyboardsettings);
        CharSequence itemInputMethod = getString(R.string.cmd_keyboard_options_choosekeyboard);
        CharSequence hideMethod = getString(R.string.cmd_keyboard_options_hidekeyboard);
        ...
        builder.setTitle(getString(R.string.cmd_keyboard_options_dialog_title));

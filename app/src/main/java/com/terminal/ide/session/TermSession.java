...
package com.terminal.ide.session;
...
import com.terminal.ide.Exec;
import com.terminal.ide.TermDebug;
import com.terminal.ide.TermService;
import com.terminal.ide.model.UpdateCallback;
import com.terminal.ide.util.ByteQueue;
...
public class TermSession {
    ...
    private static final String DEFAULT_INITIAL_COMMAND = "export HOME=/data/data/com.terminal.ide/files;cd $HOME;export PATH=$HOME/bin:$HOME/bin/bbdir:$PATH;bash";

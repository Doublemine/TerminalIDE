...
public class installSystemActivity extends SherlockActivity implements OnClickListener {
    ...
    public Handler mInstallHandler = new Handler() {
        ...
        public void handleMessage(Message zMsg) {
            ...
            if (msg.containsKey("close_install")) {
                ...
                //Set the Text
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(installSystemActivity.this);
                ...
                //Start the service
                Intent mTSIntent = new Intent(installSystemActivity.this, TermService.class);
                ...
                Toast.makeText(installSystemActivity.this, getString(R.string.main_install_java_install_show_error) + info, Toast.LENGTH_LONG).show();
    ...
    public void onCreate(Bundle icicle) {
        ...
        WebView installfollow = (WebView) findViewById(R.id.installactivity_webView);
        installfollow.getSettings().setLayoutAlgorithm(LayoutAlgorithm.SINGLE_COLUMN);
        installfollow.getSettings().setLoadWithOverviewMode(true);

        if (CountryInfo.getInstance().getCountry(this).equals("CN")) {
            installfollow.loadUrl("file:///android_asset/html/zh/installsystemActivity_Follow.html");
        } else {
            installfollow.loadUrl("file:///android_asset/html/en/installsystemActivity_Follow.html");
        }
        installfollow.setBackgroundColor(0);
        ...
        // TextView ttv=(TextView) findViewById(R.id.test);
        //ttv.setText(Html.fromHtml(readTxt()));
        ...
        if (zButton == findViewById(R.id.install_changelog)) {
            ...
            Thread tt = new Thread() {
                public void run() {
                    ...
                    //Main HOME FOlder
                    File home = installSystemActivity.this.getFilesDir();
                    ...
                    try {
                        ...
                        filemanager.extractAsset(installSystemActivity.this, "busybox.mp3", busytar);
...
//                      Process pp = Runtime.getRuntime().exec("chmod 770 "+busytar.getPath());
                        ...
                        filemanager.extractAsset(installSystemActivity.this, CURRENT_INSTALL_ASSETFILE, systar);
    ...
    public boolean onOptionsItemSelected(com.actionbarsherlock.view.MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                return true;
            case 0: {
                startActivity(new Intent(installSystemActivity.this, aboutActivity.class));
                break;
            }

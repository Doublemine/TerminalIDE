...
import com.terminal.ide.Services.ExitService;
import com.terminal.ide.session.TermSession;
import com.terminal.ide.ui.mainAvtivity;
import com.terminal.ide.util.ServiceForegroundCompat;
import com.terminal.ide.util.TermSettings;
import com.terminal.ide.util.hardkeymappings;
import com.terminal.ide.web.webserver;
...
public class TermService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate() {
         ...
         * @author wanghao
         * @date 2015-3-27
         * 修复了重复打开Activity栈混乱的问题
         */
        //预设置通知栏部分intent
        //warning：程序真正的入口为start.class
        //现在入口修改为mainActivity
        ...
        Notification sessionBuilder = new NotificationCompat.Builder(this)
                ...
                .addAction(R.drawable.ic_action_iconfont_terminal, getText(R.string.notification_open_termianl), PendingIntent.getActivity(this, 0, openTerminalActivityIntent, Intent.FLAG_ACTIVITY_CLEAR_TOP))
                .addAction(R.drawable.ic_action_iconfont_exit, getText(R.string.notification_exit_app), PendingIntent.getService(this, 0, exitTerminalIntent, 0))
                .setOngoing(true)
                .build();
